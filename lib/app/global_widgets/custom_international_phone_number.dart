...
class CustomInternationalPhoneNumber extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    InputDecoration inputDecorationFormField = InputDecoration(
      ...
      hintTextDirection: allTranslations.currentLanguage == "ar"
          ? TextDirection.rtl
          : TextDirection.ltr,
      hintStyle:
          Theme.of(context).textTheme.bodySmall!.copyWith(fontFamily: "cairo"),
        ...
        Container(
          ...
          child: Directionality(
            ...
            child: InternationalPhoneNumberInput(
              ...
              textAlign: allTranslations.currentLanguage == "ar"
                  ? TextAlign.right
                  : TextAlign.left,
