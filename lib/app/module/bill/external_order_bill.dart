...
class ExternalOrderBill extends StatelessWidget {
  ...
  const ExternalOrderBill({super.key, required this.request});
...
class SubExternalOrderBill extends StatefulWidget {
  final Request request;
  const SubExternalOrderBill({super.key, required this.request});
                        ...
                        child: ListView(
                          children: [
                            ...
                            financialPortfoliosModel.isLoading ||
                                    financialPortfoliosModel.loadingFailed
                                ? const CircularLoading()
                                                                  ...
                                                                  Future.delayed(
                                                                    ...
                                                                    CustomDialog
                                                                      ...
                                                                      description:
                                                                        ...
                                                                        hintText:
                                                                            allTranslations.text("enterPayerId"),
                                                                        textStyle: Theme.of(context)
                                                                            .textTheme
                                                                            .bodyLarge!
                                                                            .copyWith(fontFamily: "cairo"),
                                                                      ...
                                                                      onPressed:
                                                                        ...
                                                                        await payPalModel.executePayPal(
                                                                            auth:
                                                                                payPalModel.accessToken,
                                                                            payerId: payerController.text);
                                                                        if (payPalModel.message !=
                                  ...
                                  children: [
                                    ...
                                    CustomTowText(
                                      ...
                                      titleStyle: Theme.of(context)
                                          ...
                                          .copyWith(
                                              fontWeight: FontWeight.bold),
                                      subTitle: widget.request.requestItems!
                                    ...
                                    CustomTowText(
                                      ...
                                      titleStyle: Theme.of(context)
                                          ...
                                          .copyWith(
                                              fontWeight: FontWeight.bold),
                                      subTitle:
                                          "${widget.request.requestItems!.priceSum} ${userModel.user.currencyName}",
                                      subTitleStyle: Theme.of(context)
                                          .textTheme
                                          .titleSmall!
                                          .copyWith(fontFamily: "cairo"),
                                    ...
                                    CustomTowText(
                                      ...
                                      titleStyle: Theme.of(context)
                                          ...
                                          .copyWith(
                                              fontWeight: FontWeight.bold),
                                      subTitle:
                                          "$deliveryPrice ${userModel.user.currencyName}",
                                      subTitleStyle: Theme.of(context)
                                          .textTheme
                                          .titleSmall!
                                          .copyWith(fontFamily: "cairo"),
                                    ...
                                    couponPrice == 0.0 ? 0.ph : const Divider(),
                                    ...
                                    if (discountModel.isLoading ||
                                      ...
                                      const Align(
                                        ...
                                        discountVolume.type == "balance" &&
                                        chosenPayment ==
                                            allTranslations.text("fromWallet"))
                                      Column(
                                        mainAxisAlignment:
                                            MainAxisAlignment.start,
                                        crossAxisAlignment:
                                    ...
                                    CustomTowText(
                                      ...
                                      titleStyle: Theme.of(context)
                                          ...
                                          .copyWith(
                                              fontWeight: FontWeight.bold),
                                      subTitle:
                                          "${total.toStringAsFixed(2)} ${userModel.user.currencyName}",
                                      subTitleStyle: Theme.of(context)
                                          .textTheme
                                          .titleSmall!
                                          .copyWith(fontFamily: "cairo"),
                                  ...
                                  if (connection.hasConnection) {
                                    if (chosenPayment ==
                                      ...
                                      return CustomToast.showFlutterToast(
                                        ...
                                        allTranslations.text("paymentCards")) {
