...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Future<void> _handleRefresh() async {
    ...
    return await Future.delayed(const Duration(seconds: 2), () {
      Provider.of<AdvertisementSliderModel>(context, listen: false)
          .loadData(context);
      Provider.of<MainCategoriesModel>(context, listen: false)
          .loadData(context);
        ...
        builder: (context, connection, child) {
          return Scaffold(
              ...
              appBar: PreferredSize(
                ...
                child: const CustomAppBar(isHome: true),
              ),
              key: _scaffoldKey,
              body: LiquidPullToRefresh(
                ...
                child: ListView(
                  children: [
                    noteModel.items.isEmpty ? 0.ph : const HomeNote(),
