  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      providers: [
        ...
        ChangeNotifierProvider(create: (context) => AdvertisementSliderModel(context)),
        ChangeNotifierProvider(create: (context) => MainCategoriesModel(context)),
        ...
        ChangeNotifierProvider(create: (context) => AllCategoriesModel(context)),
        ...
        ChangeNotifierProvider(create: (context) => ProductStatusModel(context)),
...
class _MaterialAppWithThemeState extends State<MaterialAppWithTheme> {
  ...
  Widget build(BuildContext context) {
    ...
    }else if (appModel.token == '' &&  appConfigProvider.splashFirstSeen == true){
      ...
      child: Consumer<ThemeModel> (
        builder: (context , model , child){
          return ScreenUtilInit(
            ...
            child: userModel.errorMessage == null ?  mainWidget : const AppStatusMessage(),
